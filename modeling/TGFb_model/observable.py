    ...
    def simulate(self, x, y0, _perturbation=None):
        ...
        for i, condition in enumerate(self.conditions):
            ...
            if sol is None:
                ...
                self.simulations[self.obs_names.index("c-Fos"), :, i] = sol.y[
                    V.cFOS, :
                ]
                self.simulations[self.obs_names.index("Phosphorylated SMAD2"), :, i] = sol.y[
                    V.ppS2, :
                ]
                self.simulations[self.obs_names.index("S2_S3_complex"), :, i] = sol.y[
                    V.ppS2_ppS3, :
                ]
                self.simulations[self.obs_names.index("S2_S3_S4_complex"), :, i] = sol.y[
                    V.ppS2_ppS3_S4, :
                ]
                self.simulations[self.obs_names.index("S2_S3_S4_cFOS_complex"), :, i] = sol.y[
                    V.ppS2_ppS3_S4_cFOS, :
                ]
                self.simulations[self.obs_names.index("mcFOS"), :, i] = sol.y[V.mcFOS,:]
